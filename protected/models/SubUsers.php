...
class SubUsers extends CActiveRecord
{
	...
	public function rules(){
		return array(
			...
			array('manageid','checkMid'),
			array('fromid,branch,isbranch', 'numerical', 'integerOnly'=>true),
			array('manageid, isbranch, branch, fromid', 'safe', 'on'=>'search'),
	...
	public function getNotUser($q=false)
	{
		...
		$sql = strtr('SELECT manageid,user_nicename,user_name AS title,fromid FROM :tabl  WHERE  :sql',
