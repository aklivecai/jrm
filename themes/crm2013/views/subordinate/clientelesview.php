...
$items = array();
foreach ($model->getNP() as $key => $value) {
    $items[] = array(
        'icon' => 'isw-bookmark',
        'label' => Tk::g($key) ,
        'url' => array(
  ...
  <?php $this->widget('bootstrap.widgets.TbDetailView', array(
    ...
    'attributes' => array(
        ...
        array(
            'name' => 'rating',
            'type' => 'raw',
            'value' => TakType::getStatus('rating', $model->rating) ,
        ) ,
        array(
            'name' => 'manageid',
            'type' => 'raw',
            'value' => $model->iManage->user_nicename
        ) ,
        array(
            'name' => 'industry',
            'type' => 'raw',
        ...
        array(
            'name' => 'display',
            'type' => 'raw',
            'value' => TakType::getStatus('display', $model->display) ,
        ) ,
        array(
            'name' => 'last_time',
