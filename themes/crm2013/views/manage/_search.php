...
$branchs = array('-1'=>$model->getAttributeLabel('branch'));
...
<?php 
 if (Tak::getAdmin()) {
  echo $form->textFieldRow($model,'fromid',array('class'=>'select-fromid','size'=>10,'style'=>'width:150px'));     
 }
?>
<?php 
...
?>
<?php 
  echo $form->textFieldRow($model,'user_name',array('size'=>10,'maxlength'=>10)); 
?>
<?php 
  echo $form->textFieldRow($model,'user_nicename',array('size'=>10,'maxlength'=>10)); 
?>
<?php 
  echo $form->textFieldRow($model,'last_login_time',array('size'=>10,'maxlength'=>10,'class'=>'type-date')); 
?>
<?php 
