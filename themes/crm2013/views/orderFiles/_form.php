...
<div class="head clearfix">
	<i class="isw-documents"></i><h1><?php echo Tk::g(array('OrderFiles',$action));?></h1>
	<ul class="buttons">
	    <li>
...
<div class="block-fluid">
	<div class="row-form clearfix" >
		<?php echo $form->textFieldRow($model,'action_id',array('size'=>25,'maxlength'=>25)); ?>
	</div>
	<div class="row-form clearfix" >
		<?php echo $form->textFieldRow($model,'file_type',array('size'=>10,'maxlength'=>10)); ?>
	</div>
	<div class="row-form clearfix" >
		<?php echo $form->textFieldRow($model,'file_name',array('size'=>60,'maxlength'=>255)); ?>
	</div>
	<div class="row-form clearfix" >
		<?php echo $form->textFieldRow($model,'file_path',array('size'=>60,'maxlength'=>255)); ?>
	</div>
